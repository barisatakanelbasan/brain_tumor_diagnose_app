...
extension HomePageExtensions on BuildContext {
  EdgeInsets get noAppBarPadding => EdgeInsets.only(top: mediaQuery.padding.top);
  EdgeInsets get defaultPaddingHorizontal => EdgeInsets.symmetric(horizontal: normalValue);
  EdgeInsets get defaultPadding => EdgeInsets.fromLTRB(normalValue, 0, normalValue, 40);
}
